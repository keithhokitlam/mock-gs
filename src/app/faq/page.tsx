...
const faqDataByLocale: Record<FAQLocale, FAQItem[]> = {
  ...
  },
  {
    ...
    answer: "Your subscription will be terminated, and access to Grocery-Share features will end. If it is a Premium (paid) account, the unused amount cannot be refunded. Any unused amount cannot be saved and applied for later use. Each sign up will trigger a new paid cycle (only applicable to Premium accounts). To return later, you can sign up again with a new subscription.",
  },
  {
